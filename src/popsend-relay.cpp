...
CDarkSendRelay::CDarkSendRelay(CTxIn& vinPopnodeIn, vector<unsigned char>& vchSigIn, int nBlockHeightIn, int nRelayTypeIn, CTxIn& in2, CTxOut& out2)
{
    vinPopnode = vinPopnodeIn;
    vchSig = vchSigIn;
...
{
    CPopnode* pmn = mnodeman.GetPopnodeByRank(nRank, nBlockHeight, MIN_PRIVATESEND_PEER_PROTO_VERSION);
