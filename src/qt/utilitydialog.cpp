    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  pop-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Pop in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
The popnode mixes up the inputs and instructs all three users' wallets to pay the now-transformed input back to themselves. \
...
For more info see <a href=\"https://github.com/PopchainOrg/PopChain-gho/tree/master/doc\">https://github.com/PopchainOrg/PopChain-gho/tree/master/doc</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Pop Core is shutting down...") + "<br /><br />" +
