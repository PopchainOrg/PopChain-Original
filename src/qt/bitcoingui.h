...
private Q_SLOTS:
    ...
    /** Switch to popnode page */
    void gotoPopnodePage();
    ...
    /** Open external (default) editor with pop.conf */
    void showConfEditor();
    /** Open external (default) editor with popnode.conf */
