...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        setPopnodeCount(model->getPopnodeCountString());
        connect(model, SIGNAL(strPopnodesChanged(QString)), this, SLOT(setPopnodeCount(QString)));
        ...
        ui->banlistWidget->setColumnWidth(BanTableModel::Address, BANSUPOP_COLUMN_WIDTH);
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Pop Core RPC console.") + "<br>" +
...
void RPCConsole::unbanSelectedNode()
{
    ...
    CSubNet possibleSupop(strNode.toStdString());

    if (possibleSupop.IsValid())
    {
        CNode::Unban(possibleSupop);
        DumpBanlist();
        clientModel->getBanTableModel()->refresh();
    }
}
