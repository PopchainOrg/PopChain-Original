...
QString ClientModel::getPopnodeCountString() const
{
...
{
    QString newPopnodeCountString = getPopnodeCountString();

    if (cachedPopnodeCountString != newPopnodeCountString)
    {
        cachedPopnodeCountString = newPopnodeCountString;

        Q_EMIT strPopnodesChanged(cachedPopnodeCountString);
    }
}
