    ...
    platformStyle(platformStyle)
{
    ...
    if (settings.value("fShowPopnodesTab").toBool()) {
        popnodeListPage = new PopnodeList(platformStyle);
        addWidget(popnodeListPage);
    }
...
void WalletView::setClientModel(ClientModel *clientModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowPopnodesTab").toBool()) {
        popnodeListPage->setClientModel(clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowPopnodesTab").toBool()) {
        popnodeListPage->setWalletModel(walletModel);
    }
...
void WalletView::gotoPopnodePage()
{
    QSettings settings;
    if (settings.value("fShowPopnodesTab").toBool()) {
        setCurrentWidget(popnodeListPage);
    }
}
