...
Pop Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Pop Core, where everyone uses
...
pay attention to for reviewers of Pop Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Pop Core uses tinyformat, which is type safe. Leave them out to avoid confusion
